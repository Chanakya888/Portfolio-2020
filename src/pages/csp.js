	...
	return (
		<div>
			...
			<div className="components-foreground">
				<CspIndex />
				<PageNavigation section1="Background1csp" section2="Solutions1csp" section3="UI-Design1csp" section4="Development1csp" nextProject="/jjn" creditsId="csp-credits-container" />
			</div>
		</div>
	);
};
