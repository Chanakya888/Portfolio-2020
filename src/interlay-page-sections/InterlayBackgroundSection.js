...
const InterlayBackgroundSection = () => {
  return (
	...
	when we transitioned to interBTC, I built a design system in Figma and converted it into code using react and storybook components. 
  Later, I worked on developing user flows, wireframes, redesigned UI of the application with new features 
  like Vault staking and Vault activity and developed several interBTC app features. 
  I've also offered support to users using interBTC app on Interlay's discord</p>
